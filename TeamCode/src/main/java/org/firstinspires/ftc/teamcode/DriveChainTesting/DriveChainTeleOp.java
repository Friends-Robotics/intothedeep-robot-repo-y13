...
import org.firstinspires.ftc.teamcode.DriveChainTesting.DriveChainRobotHardware;

@TeleOp(name="DriveChainTeleOp", group="Robot")
public class DriveChainTeleOp extends LinearOpMode {

        // Create a RobotHardware object to be used to access robot hardware.
        // Prefix any hardware functions with "robot." to access this class.
        DriveChainRobotHardware robot = new DriveChainRobotHardware(this);
